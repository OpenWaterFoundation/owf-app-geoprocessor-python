    ...
    def run_command(self):
        ...
        for source in source_list:
            ...
            if os.path.isfile(source):
                ...
                CreateLayers.convert_file_to_v_layer(self, source, use_filename, id_list, source_index)
            ...
            # if the source is a directory - the filename will ALWAYS be used as the layer ID
                ...
                for file in os.listdir(source):
                    ...
                    if file.endswith(".shp") or file.endswith(".geojson"):
                        CreateLayers.convert_file_to_v_layer(self, os.path.join(source, file), True, id_list, source_index)
