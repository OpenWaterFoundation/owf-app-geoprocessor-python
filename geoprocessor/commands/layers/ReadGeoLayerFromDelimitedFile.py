...
class ReadGeoLayerFromDelimitedFile(AbstractCommand):
    ...
    * IfGeoLayerIDExists (str, optional): This parameter determines the action that occurs if the CopiedGeoLayerID
    ...
    def __init__(self):
        ...
        # GeometryFormat
        self.parameter_input_metadata['GeometryFormat.Description'] = "the geometry representation used within " \
                "the delimited file"
        ...
        self.parameter_input_metadata['GeometryFormat.Tooltip'] = "	The geometry representation used within the " \
            ...
            "representation."
        self.parameter_input_metadata['GeometryFormat.Values'] = ["", "XY", "Y", "WKT"]
        # XColumn
        self.parameter_input_metadata['XColumn.Description'] = "the name of the column in the delimited file" \
        ...
        # YColumn
        self.parameter_input_metadata['YColumn.Description'] = "the name of the column in the delimited file " \
        ...
        self.parameter_input_metadata['YColumn.Value.Default'] = "If GeometryFormat is XY, this parameter is required."\
            " Otherwise, this parameter is ignored."
        # WKTColumn
        self.parameter_input_metadata['WKTColumn.Description'] = "the name of the column in the delimited file " \
            "that holds the WKT geometry data"
        ...
        self.parameter_input_metadata['WKTColumn.Value.Default'] = "If GeometryFormat is WKT, this parameter is " \
            " required. Otherwise, this parameter is ignored."
        # Delimiter
        self.parameter_input_metadata['Delimiter.Description'] = "The delimiter used to separate the columns of the" \
            " delimited file"
        ...
        # IfGeoLayerIDExists
        self.parameter_input_metadata['IfGeoLayerIDExists.Description'] = "the action that occurs if GeoLayerID exists"\
            " within GeoProcessor"
