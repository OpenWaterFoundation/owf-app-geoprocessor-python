...
class ReadGeoLayerFromShapefile(AbstractCommand):
    ...
    * IfGeoLayerIDExists (str, optional): This parameter determines the action that occurs if the CopiedGeoLayerID
    ...
    def __init__(self):
        ...
        super().__init__()
        # New command editor for menu and window title
        ...
        self.command_metadata['Description'] = "This command reads a GeoLayer from a file in Esri Shapefile format."
        ...
        self.parameter_input_metadata['SpatialDataFile.Tooltip'] = ("The Esri Shapefile to read (relative or absolute "
                                                                    "path; must end in .shp). ${Property} syntax is "
                                                                    "recognized.")
        ...
        self.parameter_input_metadata['IfGeoLayerIDExists.Tooltip'] = (
            "The action that occurs if the GeoLayerID already exists "
