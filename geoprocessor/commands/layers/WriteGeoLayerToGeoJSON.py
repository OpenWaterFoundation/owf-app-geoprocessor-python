...
class WriteGeoLayerToGeoJSON(AbstractCommand):
    ...
    # TODO egiles 2018-01-10 Need to talk to Steve about how to check for OutputCRS is between 0 and 15 (in more
    # TODO  general terms, how are optional parameters checked for values)

    """
    Writes a GeoLayer to a GeoJSON spatial data file.
