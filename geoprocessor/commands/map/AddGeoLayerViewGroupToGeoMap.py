...
class AddGeoLayerViewGroupToGeoMap(AbstractCommand):
    ...
    def check_command_parameters(self, command_parameters: dict) -> None:
        ...
        required_parameters = ["GeoMapID", "GeoLayerViewGroupID", "Name"]
    ...
    def validate_runtime_data(self, geomap_id, insert_before, insert_after) -> bool:
        """
    ...
    def run_command(self) -> None:
        ...
        # noinspection PyPep8Naming
        pv_Description = self.get_parameter_value("Description")  # None is OK
        # noinspection PyPep8Naming
        ...
        if self.validate_runtime_data(pv_GeoMapID, pv_InsertBefore, pv_InsertAfter):
