...
class For(AbstractCommand):
    ...
    def __init__(self):
        ...
        # IteratorProperty
        self.parameter_input_metadata['IteratorProperty.Description'] = "the processor property that will be set to " \
        ...
        self.parameter_input_metadata['IteratorProperty.Value.Default'] = "Same as Name"
        ...
        self.parameter_input_metadata['ListProperty.Value.Default'] = "Specify this or 'Sequence*' parameters"
        # If iterating over a SEQUENCE ...
        # SequenceStart
        self.parameter_input_metadata['SequenceStart.Description'] = "starting value when a sequence is specified" \
            " for iteration"
        ...
        # SequenceEnd
        self.parameter_input_metadata['SequenceEnd.Description'] = "ending value when a sequence is specified " \
            "for iteration"
        ...
        self.parameter_input_metadata['SequenceEnd.Tooltip'] = \
            ...
            "(with decimal)."
        self.parameter_input_metadata['SequenceEnd.Value.Default'] = "No default if sequence is used"
        # SequenceIncrement
        ...
        self.parameter_input_metadata['SequenceIncrement.Value.Default'] = \
        ...
        self.parameter_input_metadata['TableColumn.Tooltip'] = \
            ...
            "recognized."
        self.parameter_input_metadata['TableColumn.Value.Default'] = "No default if table is used"
        # TablePropertyMap
        self.parameter_input_metadata['TablePropertyMap.Description'] = "the names of column names and corresponding " \
            "processor property names"
        self.parameter_input_metadata['TablePropertyMap.Label'] = "Table Property Name"
        ...
        self.parameter_input_metadata['TablePropertyMap.Value.Default'] = \
