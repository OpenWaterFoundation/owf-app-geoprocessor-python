...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Resutls_GeoLayers_Table = QtGui.QTableWidget(self.Results_GeoLayers_GroupBox)
        self.Resutls_GeoLayers_Table.setObjectName(_fromUtf8("Resutls_GeoLayers_Table"))
        self.Resutls_GeoLayers_Table.setColumnCount(5)
        self.Resutls_GeoLayers_Table.setRowCount(0)
        item = QtGui.QTableWidgetItem()
        self.Resutls_GeoLayers_Table.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        self.Resutls_GeoLayers_Table.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        self.Resutls_GeoLayers_Table.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        self.Resutls_GeoLayers_Table.setHorizontalHeaderItem(3, item)
        item = QtGui.QTableWidgetItem()
        self.Resutls_GeoLayers_Table.setHorizontalHeaderItem(4, item)
        self.Resutls_GeoLayers_Table.horizontalHeader().setCascadingSectionResizes(False)
        self.Resutls_GeoLayers_Table.horizontalHeader().setDefaultSectionSize(200)
        self.Resutls_GeoLayers_Table.horizontalHeader().setSortIndicatorShown(True)
        self.Resutls_GeoLayers_Table.horizontalHeader().setStretchLastSection(True)
        self.verticalLayout_5.addWidget(self.Resutls_GeoLayers_Table)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.Resutls_GeoLayers_Table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "GeoLayer ID", None))
        item = self.Resutls_GeoLayers_Table.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Geometry", None))
        item = self.Resutls_GeoLayers_Table.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Feature Count", None))
        item = self.Resutls_GeoLayers_Table.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Coordinate Reference System", None))
        item = self.Resutls_GeoLayers_Table.horizontalHeaderItem(4)
