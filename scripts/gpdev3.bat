...
rem ===================================================================================
rem In here do the setup one time first time batch file is run in a command shell
...
rem The following sets a number of QT environment variables
...
rem Running the long-term release of the OSGeo4W QGIS by setting value to `qgis-ltr` is not supported (use gpdev.bat).
set QGISNAME=qgis
