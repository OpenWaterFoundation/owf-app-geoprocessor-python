...
rem GeoProcessor script is run from GeoProcessor scripts folder.
...
rem python %*
rem GeoProcessor calls this for setup and then does additional setup before calling Python.
