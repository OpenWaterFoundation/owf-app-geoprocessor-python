...
class RunOgrProgram(AbstractCommand):
    ...
    __command_parameter_metadata: [CommandParameterMetadata] = [
        CommandParameterMetadata("OgrProgram", str),
    ...
    def __init__(self) -> None:
        ...
        super().__init__()
        self.command_name = "RunOgrProgram"
            ...
            if use_run:
                ...
                if pv_StdoutFile is not None:
                    if pv_StdoutFile.upper() == 'LOGFILE':
                        ...
                        # Open the file to receive stdout output,
                        # perhaps the desired output of the program if it does not create its own output file.
