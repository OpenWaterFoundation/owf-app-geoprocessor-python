...
class CommentBlockEnd(AbstractCommand):
    ...
    */ comment block end.
    ...
    __command_metadata['Description'] = ('This command ends a multi-line comment block, '
    ...
    __command_metadata['EditorTitle'] = 'Edit */ comment block end'  # Does not follow normal CommandName(...)
