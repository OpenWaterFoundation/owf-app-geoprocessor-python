...
class ReadGeoLayerFromWebFeatureService(AbstractCommand):
    ...
    __parameter_input_metadata['InputUrl.Label'] = "WFS Url"
    __parameter_input_metadata['InputUrl.Tooltip'] = \
        "The Web Feature Server (WFS) URL to read. ${Property} syntax is recognized."
    ...
    __parameter_input_metadata['Description.Value.Default'] = 'GeoLayerID'
    # Properties
    ...
    def run_command(self) -> None:
        ...
        # noinspection PyPep8Naming
        pv_Description = self.get_parameter_value("Description", default_value=pv_GeoLayerID)
        # noinspection PyPep8Naming
